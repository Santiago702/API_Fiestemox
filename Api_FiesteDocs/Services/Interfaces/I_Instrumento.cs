...
namespace Api_FiesteDocs.Services.Interfaces
{
    ...
    public interface I_Instrumento
    {
        ...
        Task<List<Instrumento>> ListarIdGrupo(int Id_Grupo);
        ...
        Task<List<Instrumento>> ListarIdSeccion(int Id_Seccion);
        ...
        Task<Instrumento> Obtener(int Id_Instrumento);
        ...
        Task<Request> Crear(Instrumento instrumento);
        ...
        /// <returns>Objeto <see cref="Request"/> indicando el resultado de la operación.</returns>
        Task<Request> Editar(Instrumento instrumento);
        ...
        /// <returns>Objeto <see cref="Request"/> indicando el resultado de la operación.</returns>
        Task<Request> Eliminar(int Id_Instrumento);
    }
}
